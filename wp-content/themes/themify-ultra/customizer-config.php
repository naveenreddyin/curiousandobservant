...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'site-logo_image' => array(
			...
			'selector' => '#site-logo, .header-horizontal #site-logo, .header-minbar #site-logo, .header-leftpane #site-logo, .header-slide-out #site-logo, .boxed-compact #site-logo, .header-top-bar #site-logo',
			'prop' => 'logo',
		),
