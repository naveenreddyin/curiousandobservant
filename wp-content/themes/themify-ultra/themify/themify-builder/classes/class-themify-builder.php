...
if ( ! class_exists( 'Themify_Builder' ) ) {
	...
	class Themify_Builder {
		...
		function init() {
			...
			add_action( 'wp_ajax_column_lightbox_options', array( $this, 'column_lightbox_options_ajaxify' ), 10 );
				...
				foreach ( $enqueue_scripts as $script ) {
					switch ( $script ) {
						...
						case 'themify-builder-admin-js':
							wp_register_script( 'themify-builder-admin-js', THEMIFY_BUILDER_URI . "/js/themify.builder.admin.js",
							    array('jquery', 'themify-builder-common-js'), THEMIFY_VERSION, true );
				...
				foreach ( $enqueue_scripts as $script ) {
					switch ( $script ) {
						...
						case 'themify-builder-front-ui-js':
							// front ui js
							wp_register_script( $script, THEMIFY_BUILDER_URI . "/js/themify.builder.front.ui.js",
								array( 'jquery', 'jquery-ui-tabs', 'themify-builder-common-js' ), THEMIFY_VERSION, true );
							wp_enqueue_script( $script );
		 ...
		 */
		function column_lightbox_options_ajaxify() {
			check_ajax_referer( 'tfb_load_nonce', 'nonce' );
			$this->load_form = 'column';
			...
			<div class="module_menu_front">
				<ul class="themify_builder_dropdown_front">
					<li class="themify_module_menu"><span class="ti-menu"></span>
						<ul>
							<li><a href="#" title="<?php _e('Export', 'themify') ?>" rel="themify-tooltip-bottom"
							        class="themify_builder_export_component ti-export" data-component="module">
								<?php _e('Export', 'themify') ?>
							</a></li>
							<li><a href="#" title="<?php _e('Import', 'themify') ?>" rel="themify-tooltip-bottom"
							...
							<li><a href="#" title="<?php _e('Copy', 'themify') ?>" rel="themify-tooltip-bottom"
							        class="themify_builder_copy_component ti-files" data-component="module">
								<?php _e('Copy', 'themify') ?>
							</a></li>
							<li><a href="#" title="<?php _e('Paste', 'themify') ?>" rel="themify-tooltip-bottom"
							        class="themify_builder_paste_component ti-clipboard" data-component="module">
								<?php _e('Paste', 'themify') ?>
							</a></li>
							<li class="separator"><div></div></li>
							<li><a href="#" title="<?php _e('Edit', 'themify') ?>" rel="themify-tooltip-bottom"
							        class="themify_module_options" data-module-name="<?php echo esc_attr( $mod_name ); ?>">
							            <?php _e('Edit', 'themify') ?>
							</a></li>
							<li><a href="#" title="<?php _e('Duplicate', 'themify') ?>" rel="themify-tooltip-bottom"
							        class="themify_module_duplicate">
										<?php _e('Duplicate', 'themify') ?>
							</a></li>
							<li><a href="#" title="<?php _e('Delete', 'themify') ?>" rel="themify-tooltip-bottom"
		...
		function extend_post_types( $types ) {
			...
			return array_merge( $types, $this->public_post_types );
		}
		...
		function get_custom_styling_legacy( $style_id, $mod_name, $settings, $array = false, $format = 'tag' ) {
			...
			if ( $mod_name == 'row' ) {
				...
				$styles_selector = array(
					...
					'.module_column h1' => array( 'color' ),
					'.module_column h2' => array( 'color' ),
					'.module_column h3:not(.module-title)' => array( 'color' ),
					'.module_column h4' => array( 'color' ),
					'.module_column h5' => array( 'color' ),
					'.module_column h6' => array( 'color' ),
				);
				...
				$styles_selector = array(
					...
					'.sub_column h1' => array( 'color' ),
					'.sub_column h2' => array( 'color' ),
					'.sub_column h3:not(.module-title)' => array( 'color' ),
					'.sub_column h4' => array( 'color' ),
					'.sub_column h5' => array( 'color' ),
					'.sub_column h6' => array( 'color' ),
				);
			} else {
		 ...
		 */
		private function do_slider_background( $row_or_col, $order, $builder_type = 'row' ) {
		...
		private function do_color_overlay( $styling ) {
			...
			$cover_color = ( $styling['cover_color'] != '' ) ? 'style="background-color: ' . esc_attr( $this->get_rgba_color( $styling['cover_color'] ) ) . '" data-color="'. esc_attr( $this->get_rgba_color( $styling['cover_color'] ) ) .'"' : '';
			$cover_hover_color = ( $styling['cover_color_hover'] != '' ) ? 'data-hover-color="' . esc_attr( $this->get_rgba_color( $styling['cover_color_hover'] ) ) . '"' : '';
		...
		public function get_template_row( $rows, $row, $builder_id, $echo = false, $frontedit_active = null ) {
			...
			if( ! $frontedit_active ) {
				if(
					...
					|| ( isset( $row['cols'] ) && count( $row['cols'] ) == 1 && empty( $row['cols'][0]['modules'] ) && ! isset( $row['styling'] ) ) // there's only one column and it's empty
				) {
					return '';
				}
			}
			...
			<div data-gutter="<?php echo esc_attr( $row_gutter_class ); ?>" class="<?php echo esc_attr( implode( ' ', $row_classes ) ); ?>" <?php echo $video_data; ?>
				...
				<div class="themify_builder_row_top">
					...
					<ul class="row_action">
						<li><a href="#" title="<?php _e('Export', 'themify') ?>" class="themify_builder_export_component"
						        data-component="row" rel="themify-tooltip-bottom">
									<span class="ti-export"></span>
						</a></li>
						<li><a href="#" title="<?php _e('Import', 'themify') ?>" class="themify_builder_import_component"
						        data-component="row" rel="themify-tooltip-bottom">
									<span class="ti-import"></span>
						</a></li>
						<li class="separator"></li>
						<li><a href="#" title="<?php _e('Copy', 'themify') ?>" class="themify_builder_copy_component"
						        data-component="row" rel="themify-tooltip-bottom">
						        <span class="ti-files"></span>
						</a></li>
						<li><a href="#" title="<?php _e('Paste', 'themify') ?>" class="themify_builder_paste_component"
								data-component="row" rel="themify-tooltip-bottom">
									<span class="ti-clipboard"></span>
						</a></li>
						<li class="separator"></li>
						<li><a href="#" title="<?php _e('Options', 'themify') ?>" class="themify_builder_option_row"
								 rel="themify-tooltip-bottom">
									<span class="ti-pencil"></span>
						</a></li>
						<li><a href="#" title="<?php _e('Duplicate', 'themify') ?>" class="themify_builder_duplicate_row"
								 rel="themify-tooltip-bottom">
									<span class="ti-layers"></span>
						</a></li>
						<li><a href="#" title="<?php _e('Delete', 'themify') ?>" class="themify_builder_delete_row"
								 rel="themify-tooltip-bottom">
									<span class="ti-close"></span>
						</a></li>
						<li class="separator"></li>
						<li><a href="#" title="<?php _e('Toggle Row', 'themify') ?>" class="themify_builder_toggle_row">
